let parts = [];
        ...
        function createResultCards(parts) {
            parts.forEach(part => {
                ...
                // Check if image exists and add it to the card content
                const imagePath = `images/${part["No."]}.jpg`; // Assuming .jpg for all images
                
                cardContent += `<img src="${imagePath}" alt="${part["Description"]}" class="part-image" onerror="this.style.display='none'">`;
